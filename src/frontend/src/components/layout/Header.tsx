    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            {settings?.logo_url ? (
              <img src={API_BASE + settings.logo_url} alt="Logo" className="w-10 h-10 object-contain bg-white rounded p-1" />
            ) : (
              ...
              >
                <div className="flex flex-col h-full">
                  <div className="flex items-center gap-2.5 px-5 py-5 border-b border-border/40 bg-muted/30">
                    {settings?.logo_url ? (
                      <img src={API_BASE + settings.logo_url} alt="Logo" className="w-9 h-9 object-contain bg-white rounded p-1 shadow-sm" />
                    ) : (
